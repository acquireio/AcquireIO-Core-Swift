...
typedef SWIFT_ENUM(NSInteger, AIOCallType, open) {
  AIOCallTypeAudio = 0,
  AIOCallTypeVideo = 1,
};
...
/// *
/// *   @available Available in SDK version 1.0 or later
- (void)showSupport:(UIViewController * _Nonnull)viewController withReference:(NSString * _Nonnull)reference;
...
/// @available Available in SDK version 1.0 or later
- (void)showSupport:(UIViewController * _Nonnull)viewController withReference:(NSString * _Nonnull)reference withMessage:(NSString * _Nonnull)message;
...
- (void)showCallSupportWithCallType:(enum AIOCallType)callType;
/// Start a connection session with acquire server. After calling startSession, the AcquireIODelegate delegate will receive either didChangeConnectionStatus: or onError:.
/// <em>setAccount: should be called first.</em>
- (void)startSession;
...
enum CobrowseSessionStatus : NSInteger;

SWIFT_PROTOCOL("_TtP12AcquireIOSDK17AcquireIODelegate_")
@protocol AcquireIODelegate
@optional
/// Start a connection session with acquire server. After calling startSession, the AcquireIODelegate delegate will receive either didChangeConnectionStatus: or onError:.
/// <em>setAccount: should be called first.</em>
/// @Available Available in SDK version 1.0 or later
- (void)didChangeConnectionStatusWithStatus:(enum AcquireIOConnectionStatus)status;
/// Optional method changeAgentStatus
/// *  @param agentID Agent Unique ID
/// *  @param status AgentStatus
/// *
/// *  @available Available in SDK version 1.0 or later
- (void)didChangeAgentStatusWithAgentID:(NSString * _Nonnull)agentID andStatus:(enum AcquireIOAgentStatus)status;
...
/// *
/// *  @available Available in SDK version 1.0 or later
- (void)didUpdateUnreadCount:(NSInteger)count;
/// Optional method didOpenAcquireSupport. Call when support view controller Open
/// *
/// *  @available Available in SDK version 1.1.2 or later
- (void)didOpenAcquireSupport;
...
/// @param data NSDictionary/[String : Any]
/// @available Available in SDK version 1.0 or later
- (void)didUserInteractedWithEvent:(enum AcquireIOInteractionEventType)type withData:(NSDictionary<NSString *, id> * _Nullable)data;
...
/// *
/// *  @available Available in SDK version 1.0 or later
- (void)didReceiveTriggerEvent:(NSString * _Nonnull)eventName;
/// When change status of call support
/// *
/// *  @available Available in SDK version 1.0 or later
- (void)onCallSupportStatusChange:(enum AcquireIOCallSupportStatus)status withMessage:(NSString * _Nullable)message;
...
/// *
/// *  @available Available in SDK version 1.0.0 or later
- (void)didCobrowseSessionStateChange:(enum CobrowseSessionStatus)status;
@end
...
@interface UITextField (SWIFT_EXTENSION(AcquireIOSDK))
